...
wget https://github.com/saskakarac/librealsense.git
cd ./librealsense
...
cmake ../ -DFORCE_LIBUVC=true -DCMAKE_BUILD_TYPE=release -DBUILD_NETWORK_DEVICE=true -DFORCE_RSUSB_BACKEND=true
make -j2
sudo make install
